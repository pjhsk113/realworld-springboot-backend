...
public class UserRestController {
    ...
    public ResponseEntity<UserResponse> login(@RequestBody @Valid LoginRequest request) throws Exception {
        UserEntity user = userService.login(request.toLoginRequest());
    ...
    @GetMapping("/user")
    public ResponseEntity<UserResponse> find(@AuthenticationPrincipal UserEntity user,
    ...
    @PutMapping("/user")
    public ResponseEntity<UserResponse> update(@AuthenticationPrincipal UserEntity user,
