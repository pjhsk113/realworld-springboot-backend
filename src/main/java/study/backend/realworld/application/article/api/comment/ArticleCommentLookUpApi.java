...
import study.backend.realworld.application.article.application.comment.CommentFindQueryExecutor;
...
public class ArticleCommentLookUpApi {
    private final CommentFindQueryExecutor commentFindQueryExecutor;
    ...
    public ResponseEntity<MultipleCommentResponse> getComments(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(
                MultipleCommentResponse.from(commentFindQueryExecutor.findAllCommentsOnArticle(user, slug))
        );
    }
}
